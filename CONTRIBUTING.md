...
- Search [existing issues](https://github.com/core-red-project/pm2-eid-is-discord/issues) before opening a new one.
...
Open a [GitHub Issue](https://github.com/core-red-project/pm2-eid-is-discord/issues/new/choose) using the bug report template.
...
Open a [GitHub Issue](https://github.com/core-red-project/pm2-eid-is-discord/issues/new/choose) using the feature request template, or submit a PR directly if the change is small and self-contained.
...
```
feat: add agnostic webhook payload formatter
fix: prevent 404 error on missing favicon requests
docs: update installation steps for Docker deployment
